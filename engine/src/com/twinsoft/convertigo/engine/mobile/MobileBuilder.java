...
public class MobileBuilder {
	...
	enum GeneratorType {
		...
		static IonicGenerator getIonicGenerator(MobileBuilder mb, GeneratorType gt) {
			switch (gt) {
				case Ionic4Angular:
					return null;//mb.new Ionic4Angular();
				case Ionic3Angular:
				default:
					return mb.new Ionic3Angular();
			}
		}
	}
	...
	abstract class IonicGenerator {
		...
		protected abstract Map<String,String> getAppTplTsImports();
		protected abstract Map<String,String> getPageTplTsImports();
	...
	class Ionic3Angular extends IonicGenerator {
		
		@Override
		GeneratorType getType() {
			return GeneratorType.Ionic3Angular;
		}

		@Override
		protected Map<String,String> getAppTplTsImports() {
		...
		@Override
		protected Map<String,String> getPageTplTsImports() {
	...
	private synchronized void init() throws EngineException {
		...
		if (isIonicTemplateBased()) {
			...
			if (generator == null) {
				...
				generator = GeneratorType.getIonicGenerator(this, isIonic4 ? GeneratorType.Ionic4Angular : GeneratorType.Ionic3Angular);
			}
	...
	public boolean hasAppTplImport(String name) {
		return generator.getAppTplTsImports().containsKey(name);
	}
	
	public boolean hasPageTplImport(String name) {
		return generator.getPageTplTsImports().containsKey(name);
	}
